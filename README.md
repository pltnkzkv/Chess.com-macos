# Unofficial web client for chess.com
...
```
cd existing_repo
git remote add origin https://hub.mos.ru/pltnkzkv/unofficial_web_client_for_chess.com.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/pltnkzkv/unofficial_web_client_for_chess.com/-/settings/integrations)
